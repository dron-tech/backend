...
namespace Persistence.Migrations
{
    ...
    [Migration("20230605061342_AddNftComment")]
    partial class AddNftComment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.NftComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("NftComments");
                });

            modelBuilder.Entity("Domain.Entities.NftLike", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 6, 5, 6, 13, 42, 126, DateTimeKind.Utc).AddTicks(9860),
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2023, 6, 5, 6, 13, 42, 126, DateTimeKind.Utc).AddTicks(9870),
                            Name = "Admin",
            ...
            modelBuilder.Entity("Domain.Entities.VideoLike", b =>
                {
                    b.HasOne("Domain.Entities.User", "User")
                        .WithMany("VideosLikesEnumerable")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.Navigation("VideosLikesEnumerable");
                });
